...
export default function Header() {
  ...
  return (
    <header
      className="bg-navy-950 sticky top-0 z-50"
      style={{ boxShadow: "0 2px 24px rgba(0,0,0,.32)" }}
    >
      {/* Gold accent stripe */}
      ...
      <div
        className="px-6 py-1 flex justify-between items-center border-b border-white/6"
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-[5px]">
            ...
            <div className="hidden md:flex items-center gap-1.5">
              ...
              <span className="text-[9.5px] text-white/35 tracking-[1px] uppercase font-medium">
                DGOMS v1 · Live
              </span>
            </div>
          </div>
